...
public class INTERFACESCREEN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Gửi tiền tiết kiệm");

        jButton3.setText("Xem Lịch sử giao dịch");

        jButton4.setText("Đặt vé máy bay");

        jButton5.setText("Nạp thẻ cào ");

        jButton6.setText("Thanh toán hóa đơn");

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DOAN/718223 (1).png"))); // NOI18N
